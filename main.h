...
/**
 * struct buffer_s - Structure defining a buffer.
 * @buffer: Pointer to a character array.
 * @start: Pointer to the start of the buffer.
 * @len: Length of the string stored in the buffer.
 */
...
/**
 * struct converter_s - Structure defining a converter.
 * @specifier: Character representing a conversion specifier.
 * @func: Pointer to a conversion function corresponding to the specifier.
 */
...
/**
 * struct flag_s - Structure defining a flags.
